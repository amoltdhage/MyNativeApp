...
const SignupScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {showAccountInfo && (
        <View>
          <TextInput placeholder="First Name" value={firstName} onChangeText={setFirstName} style={styles.input} placeholderTextColor="gray" />
          <TextInput placeholder="Last Name" value={lastName} onChangeText={setLastName} style={styles.input} placeholderTextColor="gray" />
          <TextInput placeholder="Email" value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" style={styles.input} placeholderTextColor="gray" />

          {/* Password */}
          <View style={styles.passwordContainer}>
            <TextInput placeholder="Password" value={password} onChangeText={setPassword} secureTextEntry={!showPassword} style={styles.passwordInput} placeholderTextColor="gray" />
          ...
          {/* Confirm Password */}
          <View style={styles.passwordContainer}>
            <TextInput placeholder="Confirm Password" value={confirmPassword} onChangeText={setConfirmPassword} secureTextEntry={!showConfirmPassword} style={styles.passwordInput} placeholderTextColor="gray" />
      ...
      {showPersonalInfo && (
        <View>
          <TextInput placeholder="Mobile Number" value={mobile} onChangeText={text => /^\d*$/.test(text) && text.length <= 10 && setMobile(text)} keyboardType="numeric" style={styles.input} placeholderTextColor="gray" />
          ...
          <TextInput placeholder="Age" value={age} onChangeText={text => isNumeric(text) && setAge(text)} keyboardType="numeric" style={styles.input} placeholderTextColor="gray" />
          <TextInput placeholder="Height (cm)" value={height} onChangeText={text => isNumeric(text) && setHeight(text)} keyboardType="numeric" style={styles.input} placeholderTextColor="gray" />
          <TextInput placeholder="Weight (kg)" value={weight} onChangeText={text => isNumeric(text) && setWeight(text)} keyboardType="numeric" style={styles.input} placeholderTextColor="gray" />
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#FF69B4', marginBottom: 15, padding: 12, borderRadius: 25, backgroundColor: '#fff', color: "#000" },
